...
export class ProfileView extends React.Component {
  ...
  removeFav(fav) {
    ...
    .then(response => {
      ...
      // let tempArray = [...this.state.favoriteMovies.split(",")];
      // alert("BOOM")
      // console.log(this.state.favoriteMovies, tempArray)
      // tempArray.splice(tempArray.indexOf(fav._id), 1); //all array methods either mutate actual array or create new array
      this.setState({
        favoriteMovies: this.state.favoriteMovies.split(",").filter( id => id !== fav._id).join(',')
      });
    })
    .catch(e => {
      console.log(e),
